...
public class ProofServiceImpl implements ProofService {
    ...
    @Override
    public String uploadProofWithoutValidation(String uniqueCode, MultipartFile file, boolean replaceExisting) throws IOException {
        // Only check for empty file (basic safety check)
        if (file.isEmpty()) {
            throw new IllegalArgumentException("Proof file is empty");
        }
        ...
        // Check if proof already exists and handle based on parameter
        String existingFilePath = getProofFilePath(uniqueCode);
        if (existingFilePath != null) {
            if (replaceExisting) {
                try {
                ...
                throw new IllegalArgumentException("Proof already exists for unique code: " + uniqueCode + ". Set replaceExisting=true to allow replacement.");
            }
        }
